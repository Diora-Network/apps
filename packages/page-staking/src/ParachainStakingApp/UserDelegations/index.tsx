...
function UserDelegations ({ roundInfo }: Props): React.ReactElement<Props> | null {
  ...
  const headerRef = useRef(
    [
      [t('masternode address'), 'start'],
      [t('staked amount'), 'media--1000'],
      [t('stake more'), 'media--1000'],
      [t('stake less'), 'media--1000'],
      [t('revoke'), 'media--1000'],
  ...
  return (<>
    <InputAddress
      help={t<string>('The account you will use to vote.')}
    ...
    />
    {
      ...
      >
        {delegations && delegations.length
          ...
          : <tr>
            <td colSpan={6}>
              <div className='empty'>{t('No staked ammount for this address')}</div>
            </td>
          </tr>}
      </Table>
    }
