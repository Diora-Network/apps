...
function BondLessModal ({ className = '', delegation, delegatorAddress, onClose, roundDuration }: Props): React.ReactElement<Props> {
  ...
  return (
    <Modal
      ...
      header={t<string>('schedule stake less')}
      onClose={onClose}
      size='large'
    >
      <Modal.Content>
        <div className={className}>
          ...
          >
            <InputAddress
              ...
              help={t<string>('The account that has an active delegation on the masternode candidate.')}
              isDisabled
          ...
          <Modal.Columns hint={t<string>("Decrease your stake by this amount. You can't decrease past the minimum staked amount.")}>
            {
              <InputBalance
                autoFocus
                isZeroable
      ...
      <Modal.Actions>
        <TxButton
          ...
          label={t<string>('schedule stake less')}
          onStart={onClose}
          params={
